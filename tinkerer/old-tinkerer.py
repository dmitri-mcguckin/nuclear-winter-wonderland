...
from tinkerer.pack import ModPack, Version, ForgeVersion, ATTRS
from tinkerer.mod import Mod
from shutil import *
...
def load_manifest(filename):
    ...
    pack = ModPack(name, pack_version, mc_version, forge_version, author, sponge_version = sponge_version)
